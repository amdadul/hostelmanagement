        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-card-center">Edit a Asset type</h4>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" class="form-control @error('name') is-invalid @enderror"
                                           placeholder="Asset Type Name" name="name" value="{{old('name')?old('name'):$data->name}}" />
                                    @error('name')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
...
@push('scripts')
    <script>
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('accounts.asset-types.update',$data->id) }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),
