        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-card-center">Edit a Assets</h4>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control @error('assets_type') is-invalid @enderror" id="assets_type" name="assets_type" required>
                                        ...
                                        @foreach($assetTypes as $assetType)
                                            <option value="{{$assetType->id}}" {{ (old('assets_type')?old('assets_type'):$data->assets_type)==$assetType->id?'selected':'' }}>{{$assetType->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('assets_type')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                                              placeholder="Description" name="description" required>{{old('description')?old('description'):$data->description}}</textarea>
                                    @error('description')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="qty" class="form-control @error('qty') is-invalid @enderror"
                                           placeholder="Quantity" name="qty" value="{{old('qty')?old('qty'):$data->qty}}" />
                                    @error('qty')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="depreciation" class="form-control @error('depreciation') is-invalid @enderror"
                                           placeholder="Depreciation" name="depreciation" value="{{old('depreciation')?old('depreciation'):$data->depreciation}}" />
                                    @error('depreciation')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="life_time" class="form-control @error('life_time') is-invalid @enderror"
                                           placeholder="Life Time" name="life_time" value="{{old('life_time')?old('life_time'):$data->life_time}}" />
                                    @error('life_time')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
...
@push('scripts')
    <script>
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('accounts.assets.update',$data->id) }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),
