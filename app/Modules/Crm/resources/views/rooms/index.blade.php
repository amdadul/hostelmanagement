@extends('admin.app')
@section('title') {{ isset($pageTitle)?$pageTitle:'Rooms' }} @endsection
@push('styles')
...
@push('scripts')
    ...
    <script>
        $('#rooms-table').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#rooms-table').DataTable().draw(false);
