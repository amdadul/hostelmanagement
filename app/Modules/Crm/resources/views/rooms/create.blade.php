    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-card-center">Create a Room</h4>
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="room_name" class="form-control @error('room_name') is-invalid @enderror"
                                          placeholder="Room Name" name="room_name" value="{{old('room_name')?old('room_name'):''}}" />
                                @error('room_name')
                                <div class="help-block text-danger">{{ $message }} </div> @enderror
                            </div>
    ...
    $().ready(function () {
        $('form#building').submit(function (e) {
            ...
            if (building_name === 0 || building_name <= 0) {
                ...
                toastr.warning(" Please enter room name!", 'Message <i class="fa fa-bell faa-ring animated"></i>');
                return false;
            } else {
                ajaxSave();
            }
