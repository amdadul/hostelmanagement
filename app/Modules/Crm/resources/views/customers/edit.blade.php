                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control @error('building_name') is-invalid @enderror" id="building_name" name="building_name" >
                                        ...
                                        @foreach($buildings as $building)
                                            <option value="{{$building->id}}" {{ (old('building_name')?old('building_name'):$data->room->flat->floor->building_id)==$building->id?'selected':'' }}>{{$building->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('building_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control @error('floor_name') is-invalid @enderror" id="floor_name" name="floor_name" >
                                        ...
                                        @foreach($floors as $floor)
                                            <option value="{{$floor->id}}" {{ (old('floor_name')?old('floor_name'):$data->room->flat->floor_id)==$floor->id?'selected':'' }}>{{$floor->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('floor_name')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control @error('flat_name') is-invalid @enderror" id="flat_name" name="flat_name" >
                                        ...
                                        @foreach($flats as $flat)
                                            <option value="{{$flat->id}}" {{ (old('flat_name')?old('flat_name'):$data->room->flat_id)==$flat->id?'selected':'' }}>{{$flat->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('flat_name')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control @error('room_name') is-invalid @enderror" id="room_name" name="room_name" >
                                        ...
                                        @foreach($rooms as $room)
                                            <option value="{{$room->id}}" {{ (old('room_name')?old('room_name'):$data->room_id)==$room->id?'selected':'' }}>{{$room->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('room_name')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="seat_name" class="form-control @error('seat_name') is-invalid @enderror"
                                           placeholder="Seat Name" name="seat_name" value="{{old('seat_name')?old('seat_name'):$data->name}}" required/>
                                    @error('seat_name')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="seat_code" class="form-control @error('seat_code') is-invalid @enderror"
                                           placeholder="Seat Code" name="seat_code" value="{{old('seat_code')?old('seat_code'):$data->code}}" />
                                    @error('seat_code')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="seat_price" class="form-control @error('seat_price') is-invalid @enderror"
                                           placeholder="Seat Price" name="seat_price" value="{{old('seat_price')?old('seat_price'):$data->seatPrice->price}}" required />
                                    @error('seat_price')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
...
@push('scripts')
    <script>
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('crm.seats.update',$data->id) }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),
