@extends('admin.app')
@section('title') {{ isset($pageTitle)?$pageTitle:'Flats' }} @endsection
@push('styles')
...
@push('scripts')
    ...
    <script>
        $('#flats-table').on('click', '.btn-delete[data-remote]', function (e) {
            e.preventDefault();
            $.ajaxSetup({
                headers: {
            ...
            if (confirm('Are you sure you want to delete this row?')) {
                $.ajax({
                    ...
                    $('#flats-table').DataTable().draw(false);
