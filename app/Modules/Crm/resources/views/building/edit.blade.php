        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-card-center">Building EDIT</h4>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="building_name" class="form-control @error('building_name') is-invalid @enderror"
                                           placeholder="Building Name" name="building_name" value="{{old('building_name')?old('building_name'):(isset($data)?$data->name:'N/A')}}">
                                    @error('building_name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="address" class="form-control @error('address') is-invalid @enderror"
                                              placeholder="Address" name="address">{{old('address')?old('address'):(isset($data)?$data->address:'N/A')}}</textarea>
                                    @error('address')
                                    <div class="help-block text-danger">{{ $message }} </div> @enderror
                                </div>
...
@push('scripts')
    <script>
        ...
        function ajaxSave() {
            ...
            $.ajax({
                url: "{{ route('crm.buildings.update',$data->id) }}",
                type: 'post',
                dataType: "json",
                cache: false,
                data: $('form').serialize(),
