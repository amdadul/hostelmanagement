...
class SeatsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('room_id',function ($data){
                return isset($data->room->name)?$data->room->name:'N/A';
            })
            ->editColumn('flat_id',function ($data){
                return isset($data->room->flat->name)?$data->room->flat->name:'N/A';
            })
            ->editColumn('floor_id',function ($data){
                return isset($data->room->flat->floor->name)?$data->room->flat->floor->name:'N/A';
            })
     ...
     */
    public function query(Seat $model)
    {
