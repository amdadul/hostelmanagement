...
class FlatsDataTable extends DataTable
{
    /**
                ...
                return "
                    <div class='form-group'>
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='flats/$data->id/edit' class='btn btn-icon btn-secondary'><i class='fa fa-pencil-square-o'></i> Edit</a>
                            <button data-remote='flats/$data->id/delete' class='btn btn-icon btn-danger btn-delete'><i class='fa fa-trash-o'></i> Delete</button>
                        </div>
                   </div>";
            })
            ->editColumn('floor_id',function ($data){
                return isset($data->floor->name)?$data->floor->name:'N/A';
            })
            ->editColumn('building_id',function ($data){
                return isset($data->floor->building->name)?$data->floor->building->name:'N/A';
            })
            ->rawColumns(['action'])
            ->removeColumn('id');
    }
     ...
     */
    public function query(Flat $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('floor_id')->title('Floor Name'),
            Column::make('name')->title('Flat Name'),
