                ...
                return "
                    <div class='form-group'>
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='assets/$data->id/edit' class='btn btn-icon btn-secondary'><i class='fa fa-pencil-square-o'></i> Edit</a>
                            <button data-remote='assets/$data->id/delete' class='btn btn-icon btn-danger btn-delete'><i class='fa fa-trash-o'></i> Delete</button>
                        </div>
                   </div>";
            })
            ->editColumn('assets_type',function ($data){
                return isset($data->assetsType->name)?$data->assetsType->name:'N/A';
            })
            ->rawColumns(['action'])
            ->removeColumn('id');
    }
    ...
    protected function getColumns()
    {
        return [
            Column::make('DT_RowIndex')
                ...
                ->exportable(true)
                ->printable(true),
            Column::make('assets_type')->title('Assets Type'),
            Column::make('description'),
            Column::make('qty')->title('Quantity'),
            Column::make('depreciation'),
            Column::make('life_time')->title('Life Time'),
        ];
    }
