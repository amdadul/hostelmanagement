...
class AssetTypeDataTable extends DataTable
{
    /**
                ...
                return "
                    <div class='form-group'>
                        <div class='btn-group' role='group' aria-label='Basic example'>
                            <a href='asset-types/$data->id/edit' class='btn btn-icon btn-secondary'><i class='fa fa-pencil-square-o'></i> Edit</a>
                            <button data-remote='asset-types/$data->id/delete' class='btn btn-icon btn-danger btn-delete'><i class='fa fa-trash-o'></i> Delete</button>
                        </div>
                   </div>";
            })
     ...
     *
     * @param AssetsType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(AssetsType $model)
    {
    ...
    protected function getColumns()
    {
        return [
            Column::make('DT_RowIndex')
                ...
                ->exportable(true)
                ->printable(true),
            Column::make('root_id')->title('Root Expense Type'),
