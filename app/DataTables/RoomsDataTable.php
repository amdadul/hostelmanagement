    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('flat_id',function ($data){
                return isset($data->flat->name)?$data->flat->name:'N/A';
            })
            ->editColumn('floor_id',function ($data){
                return isset($data->flat->floor->name)?$data->flat->floor->name:'N/A';
            })
            ->editColumn('building_id',function ($data){
                return isset($data->flat->floor->building->name)?$data->flat->floor->building->name:'N/A';
            })
            ->rawColumns(['action'])
            ->removeColumn('id');
    }
